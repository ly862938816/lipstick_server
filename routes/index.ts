        ...
        [{
            ...
            "boards":
                [
                    ...
                    //     "long_description": "Steven van Broeckhoven and shaper Werner Gnigler have developed the three sizes, 90,100 and 106. Two of the sizes were already ﬂawless for today's powerful double moves and trick combos. These moves require fast and direct boards with explosive pop 'even a 2nd and 3rd time' and the 90 and 100 were up to that! Steven and Youp Schmit are more than happy with their feeling and performance. So we left them unchanged. Nevertheless, Steven had the intention to adapt the light air freestyle board not only to fulﬁll the highest standards of modern freestyle in lighter winds but also to make it feel as radical as its smaller brothers.", 
                    //     "sizes": 
                    //         [
